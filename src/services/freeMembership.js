...
const messageFree = () => {
  ...
  <p style="text-align: justify;">
    ...
    <br>
    <br>
    &emsp;&emsp;&emsp;Comikamedia sudah resmi menasbihkan diri sebagai media online komedi, yang menggunakan sistem berlangganan. Demi reportase yang lebih mendalam, reporter kami mempertaruhkan kesehatan mata dengan riset berjam-jam dari laptop, membelah jalanan untuk mewartakan fenomena komedi dengan lebih dekat, hingga sok asik kepada komika demi mengorek informasi orang dalam. Kalau kamu cinta komedi, harga berlangganan Comikamedia tak lebih mahal dari beli saham, tapi bisa jadi investasi! Nah, kamu beruntung karena di bulan pertama ini, pembelanjaan produk Comika apapun akan mendapatkan satu bulan gratis akses berlangganan. Semoga suka ya!
    <br>
    <br>
