...
router.get('/:slug', slugArticle, getCommentController.service)
    .post("/:slug", createCommentController.validation, validator, checkToken, slugArticle, createCommentController.service)
